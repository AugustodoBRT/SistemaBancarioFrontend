export const environment = {
  production: true,
  baseUrl: 'https://sistemabancario-ds.onrender.com',
  ...
  apiUpdatePixUrl: "/accounts/pix",
  apiGetAccountPixUrl: "/accounts/pix",
  apiUrlGetUserHistory: "/users/history",
  apiUrlUpdatePassword: "/api/update-password"
};
